// https://observablehq.com/@jimpick/provider-quest-maxmind-geolite2-lookups@162
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("ipsArray")).define("ipsArray", ["ips"], _ipsArray);
