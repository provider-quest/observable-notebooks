...
function _10(md,devFundsAddress,devFundsDelegatedAddress,devFundsId,devFundsBalance)
{
  return md`
...
async function* _37(transferFundsStatus,md,Promises)
{
...
function _49(md,devFundsId){return(
...
function _51(evmBytes,html,button,constructorParamsForm,md){return(
...
async function* _63(createActorStatus,md,Promises,html)
{
...
async function* _72(invokeEvmMethodStatus,md,Promises,invokeEvmMethodButton,html)
{
...
function _75(md,devFundsId){return(
...
async function* _79(transferFromOwnerStatus,md,Promises,transferFromOwnerButton,html)
{
...
async function* _84(tokenBalancesStatus,md,Promises,transferFundsStatus,Inputs)
{
...
async function* _93(transferFromUserStatus,md,Promises,transferFromUserButton,html)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["md","devFundsAddress","devFundsDelegatedAddress","devFundsId","devFundsBalance"], _10);
  ...
  main.variable(observer()).define(["md","devFundsId"], _49);
  main.variable(observer()).define(["md"], _50);
  main.variable(observer()).define(["evmBytes","html","button","constructorParamsForm","md"], _51);
  ...
  main.variable(observer()).define(["createActorStatus","md","Promises","html"], _63);
  ...
  main.variable(observer()).define(["invokeEvmMethodStatus","md","Promises","invokeEvmMethodButton","html"], _72);
  ...
  main.variable(observer()).define(["md","devFundsId"], _75);
  ...
  main.variable(observer()).define(["transferFromOwnerStatus","md","Promises","transferFromOwnerButton","html"], _79);
  ...
  main.variable(observer()).define(["tokenBalancesStatus","md","Promises","transferFundsStatus","Inputs"], _84);
  main.variable(observer()).define(["Inputs","mutable invalidatedBalancesAt"], _85);
  ...
  main.variable(observer()).define(["transferFromUserStatus","md","Promises","transferFromUserButton","html"], _93);
