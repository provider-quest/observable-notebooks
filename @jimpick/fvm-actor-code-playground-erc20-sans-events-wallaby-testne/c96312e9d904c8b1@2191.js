...
function _50(md,devFundsId){return(
...
function _52(evmBytes,html,button,constructorParamsForm,md){return(
...
async function* _64(createActorStatus,md,Promises,html)
{
...
function _70(md,devFundsId){return(
...
async function* _73(invokeEvmMethodStatus,md,Promises,invokeEvmMethodButton,html)
{
...
function _76(md,devFundsId){return(
...
async function* _80(transferFromOwnerStatus,md,Promises,transferFromOwnerButton,html)
{
...
async function* _85(tokenBalancesStatus,md,Promises,transferFundsStatus,Inputs)
{
...
async function* _94(transferFromUserStatus,md,Promises,transferFromUserButton,html)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["md","devFundsId"], _50);
  main.variable(observer()).define(["md"], _51);
  main.variable(observer()).define(["evmBytes","html","button","constructorParamsForm","md"], _52);
  ...
  main.variable(observer()).define(["createActorStatus","md","Promises","html"], _64);
  ...
  main.variable(observer()).define(["invokeEvmMethodStatus","md","Promises","invokeEvmMethodButton","html"], _73);
  ...
  main.variable(observer()).define(["md","devFundsId"], _76);
  ...
  main.variable(observer()).define(["transferFromOwnerStatus","md","Promises","transferFromOwnerButton","html"], _80);
  ...
  main.variable(observer()).define(["tokenBalancesStatus","md","Promises","transferFundsStatus","Inputs"], _85);
  main.variable(observer()).define(["Inputs","mutable invalidatedBalancesAt"], _86);
  ...
  main.variable(observer()).define(["transferFromUserStatus","md","Promises","transferFromUserButton","html"], _94);
