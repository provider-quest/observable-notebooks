...
function _9(md,devFundsMnemonic){return(
...
function _11(md,devFundsAddress,devFundsDelegatedAddress,devFundsId,devFundsBalance)
{
  return md`
...
function _14(md,devFundsAddress){return(
...
function _29(md,randomMnemonic){return(
...
async function* _38(transferFundsStatus,md,Promises)
{
...
function _43(Inputs,initialBalances,keys,transferFundsStatus,FilecoinNumber){return(
Inputs.table(
...
function _50(md,ownerId){return(
...
async function* _55(createActorStatus,md,Promises,html)
{
...
async function* _createActorStatus(createActorButton,factory,ownerKey,deployer,provider,client,waitEthTx,filecoinAddress)
{
...
function _65(md,ownerId){return(
...
function _68(invokeEvmMethodButton,md){return(
invokeEvmMethodButton ? md`Balance: ${invokeEvmMethodButton}` : md``
)}

function _69(md,ownerId){return(
...
async function* _73(transferFromOwnerStatus,md,Promises,createActorStatus,html)
{
...
function _78(tokenBalances,md,Inputs,keys,transferFundsStatus)
{
  if (!tokenBalances) {
    return md``
  } else {
...
async function* _87(transferFromUserStatus,md,Promises,createActorStatus,html)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["md","devFundsMnemonic"], _9);
  main.variable(observer()).define(["md"], _10);
  main.variable(observer()).define(["md","devFundsAddress","devFundsDelegatedAddress","devFundsId","devFundsBalance"], _11);
  main.variable(observer()).define(["Inputs","mutable invalidatedDevFundsIdAt","mutable invalidatedDevFundsBalanceAt"], _12);
  main.variable(observer()).define(["md"], _13);
  main.variable(observer()).define(["md","devFundsAddress"], _14);
  ...
  main.variable(observer()).define(["ownerKey"], _35);
  main.variable(observer()).define(["md"], _36);
  main.variable(observer()).define(["md"], _37);
  main.variable(observer()).define(["transferFundsStatus","md","Promises"], _38);
  ...
  main.variable(observer()).define(["md","ownerId"], _50);
  ...
  main.variable(observer()).define(["createActorStatus","md","Promises","html"], _55);
  ...
  main.variable(observer("createActorStatus")).define("createActorStatus", ["createActorButton","factory","ownerKey","deployer","provider","client","waitEthTx","filecoinAddress"], _createActorStatus);
  main.variable(observer("contract")).define("contract", ["createActorStatus","factory"], _contract);
  main.variable(observer()).define(["md"], _64);
  main.variable(observer()).define(["md","ownerId"], _65);
  ...
  main.variable(observer()).define(["invokeEvmMethodButton","md"], _68);
  main.variable(observer()).define(["md","ownerId"], _69);
  ...
  main.variable(observer()).define(["transferFromOwnerStatus","md","Promises","createActorStatus","html"], _73);
  ...
  main.variable(observer()).define(["tokenBalances","md","Inputs","keys","transferFundsStatus"], _78);
  ...
  main.variable(observer()).define(["transferFromUserStatus","md","Promises","createActorStatus","html"], _87);
