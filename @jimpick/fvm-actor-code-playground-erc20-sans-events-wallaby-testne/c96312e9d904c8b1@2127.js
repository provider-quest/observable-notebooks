...
function _27(md,randomMnemonic){return(
...
function _40(Inputs,initialBalances,keys,transferFundsStatus,FilecoinNumber){return(
Inputs.table(
...
function _46(md,devFundsId){return(
...
function _48(evmBytes,html,button,constructorParamsForm,md){return(
...
async function* _60(createActorStatus,md,Promises,html)
{
...
function _66(md,devFundsId){return(
...
async function* _69(invokeEvmMethodStatus,md,Promises,invokeEvmMethodButton,html)
{
...
function _72(md,devFundsId){return(
...
async function* _76(transferFromOwnerStatus,md,Promises,transferFromOwnerButton,html)
{
...
async function* _81(tokenBalancesStatus,md,Promises,transferFundsStatus,Inputs)
{
...
async function* _90(transferFromUserStatus,md,Promises,transferFromUserButton,html)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["md","randomMnemonic"], _27);
  ...
  main.variable(observer()).define(["transferFundsStatus","md","Promises"], _35);
  ...
  main.variable(observer()).define(["Inputs","initialBalances","keys","transferFundsStatus","FilecoinNumber"], _40);
  ...
  main.variable(observer()).define(["md","devFundsId"], _46);
  main.variable(observer()).define(["md"], _47);
  main.variable(observer()).define(["evmBytes","html","button","constructorParamsForm","md"], _48);
  ...
  main.variable(observer()).define(["createActorStatus","md","Promises","html"], _60);
  ...
  main.variable(observer()).define(["md","devFundsId"], _66);
  ...
  main.variable(observer()).define(["invokeEvmMethodStatus","md","Promises","invokeEvmMethodButton","html"], _69);
  ...
  main.variable(observer()).define(["md","devFundsId"], _72);
  ...
  main.variable(observer()).define(["transferFromOwnerStatus","md","Promises","transferFromOwnerButton","html"], _76);
  ...
  main.variable(observer()).define(["tokenBalancesStatus","md","Promises","transferFundsStatus","Inputs"], _81);
  main.variable(observer()).define(["Inputs","mutable invalidatedBalancesAt"], _82);
  ...
  main.variable(observer()).define(["transferFromUserStatus","md","Promises","transferFromUserButton","html"], _90);
