...
function _69(invokeEvmMethodButton,md){return(
invokeEvmMethodButton ? md`Balance: ${invokeEvmMethodButton}` : md``
)}

function _70(md,ownerId){return(
...
async function* _74(transferFromOwnerStatus,md,Promises,createActorStatus,html)
{
...
function _79(tokenBalances,md,Inputs,keys,transferFundsStatus)
{
  if (!tokenBalances) {
    return md``
  } else {
...
async function* _88(transferFromUserStatus,md,Promises,createActorStatus,html)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["invokeEvmMethodButton","md"], _69);
  main.variable(observer()).define(["md","ownerId"], _70);
  ...
  main.variable(observer()).define(["transferFromOwnerStatus","md","Promises","createActorStatus","html"], _74);
  ...
  main.variable(observer()).define(["tokenBalances","md","Inputs","keys","transferFundsStatus"], _79);
  ...
  main.variable(observer()).define(["transferFromUserStatus","md","Promises","createActorStatus","html"], _88);
  ...
  main.variable(observer()).define(["buffer","filecoinAddress"], _115);
