...
function _60(invokeEvmMethodButton,md){return(
invokeEvmMethodButton ? md`Balance: ${invokeEvmMethodButton}` : md``
)}

function _61(md,ownerId){return(
...
async function* _65(transferFromOwnerStatus,md,Promises,createActorStatus,html)
{
...
function _70(tokenBalances,md,Inputs,keys,transferFundsStatus)
{
  if (!tokenBalances) {
    return md``
  } else {
...
async function* _79(transferFromUserStatus,md,Promises,createActorStatus,html)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["invokeEvmMethodButton","md"], _60);
  main.variable(observer()).define(["md","ownerId"], _61);
  ...
  main.variable(observer()).define(["transferFromOwnerStatus","md","Promises","createActorStatus","html"], _65);
  ...
  main.variable(observer()).define(["tokenBalances","md","Inputs","keys","transferFundsStatus"], _70);
  main.variable(observer()).define(["Inputs","mutable invalidatedBalancesAt"], _71);
  ...
  main.variable(observer()).define(["transferFromUserStatus","md","Promises","createActorStatus","html"], _79);
